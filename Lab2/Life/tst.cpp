...
TEST(CoreTest, tst1){
  Life::TestCore core;
  Life::Field fd = core.generateTwiceField();
  fd.processing();
...
TEST(CoreTest, tst2){
  Life::TestCore core;
  Life::Field fd = core.generateNullField();
...
TEST(CoreTest, tst3){
  Life::TestCore core;
  Life::Field fd = core.detranspField("00000000000000111100000000000101010101001010000000100101000000100101000000001001010100010001000001001000010010100100011", 10 ,10);
  fd.processing();
...
TEST(CoreTest, tst4){
  Life::TestCore core;
  Life::Field fd = core.detranspField("11101010000001010101010101010100000000000000101011111110100000101010101001011100000100010001111111100111001101011010100", 10 ,10);
  fd.processing();
